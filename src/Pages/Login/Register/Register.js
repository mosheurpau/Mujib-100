  ...
  return (
    <Container>
      <Row className="justify-content-md-center">
        <Col xs="10" lg="5" className="mt-3 mx-auto rounded-top px-5 pt-4">
          ...
          <Form onSubmit={handleRegister} className="mb-3">
            ...
            <Form.Group className="mb-3" controlId="formBasicCheckbox">
              <Form.Check
                ...
                name="terms"
                id="terms"
                label="Accept Mujib 100 Terms and Conditions"
                className={`${agree ? "" : "text-danger"}`}
              />
            </Form.Group>

            <Button type="submit" disabled={!agree} className="w-100">
              Register
            </Button>
          </Form>
          {errorElement}
